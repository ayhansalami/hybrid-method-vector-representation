...
DOC2VEC_CLUSTERING_PATH = '/Users/armanrahbar/Documents/master/term-2/SNLP/project/clustring'
MALLET_CLUSTERING_PATH = '/Users/armanrahbar/Dropbox/nlp-paper/clustering mallet/'
MALLET_HOME_PATH = '/Users/armanrahbar/Dropbox/nlp-paper/Mallet/'
DOC2VEC_TEST_PATH = '/Users/armanrahbar/Documents/master/term-2/SNLP/project/Data/'
DOC2VEC_HOME_PATH = '/Users/armanrahbar/Documents/master/term-2/SNLP/project/merged_data/'
n_features = 5000
...
def getDoc2VecInferedVector(model, foldNum):
    ...
    return model.transform(testset.data)
...
def getTfidfInferedVector(model, foldNum):
    ...
    #         [''.join([c for c in i if c not in set(punctuations)]) for i in data.lower().split() if i not in stop]))
    #     testToVectorize[-1] = testToVectorize[-1].strip()
    return model.transform(testset.data).toarray()
